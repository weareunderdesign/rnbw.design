        ...
        <div class="panel">
            ...
            <div class="border-bottom">
                <div class="justify-stretch padding-xs">
                    <div class="gap-s padding-xs">
                        ...
                        <svg-icon src="https://rnbw.design/raincons/page.svg"></svg-icon>
                ...
                <div class="justify-stretch padding-xs">
                    <div class="gap-s padding-xs">
                        <div class="icon-xs"></div>
                        <svg-icon src="https://rnbw.design/raincons/code-js.svg"></svg-icon>
                ...
                <div class="gap-s justify-start padding-s">
                    <div class="icon-xs"></div>
                    <svg-icon src="https://rnbw.design/raincons/component.svg"></svg-icon>
                    <span class="text-s">Component</span>
                </div>
                <div>
                    <div>
                        <div class="gap-s justify-start padding-s">
                            <svg-icon src="https://rnbw.design/raincons/down.svg"></svg-icon>
                            <svg-icon src="https://rnbw.design/raincons/folder.svg"></svg-icon>
            ...
            <div class="">
                <div class="justify-stretch padding-xs background-tertiary">
                    <div class="gap-s padding-xs">
                        <svg-icon src="https://rnbw.design/raincons/down.svg" id="heading3-dropdown-icon"
                            class="hidden"></svg-icon>
                        <svg-icon src="https://rnbw.design/raincons/heading.svg"></svg-icon>
                ...
                <div>
                    <div class="justify-stretch padding-xs background-secondary" id="span1" style="opacity:0;">
                        <div class="gap-s padding-xs">
                            <div class="icon-xs"></div>
                            <div class="icon-xs"></div>
                            <svg-icon src="https://rnbw.design/raincons/div.svg"></svg-icon>
        ...
        <div>
            ...
            <div class="panel padding-m gap-s">
                ...
                <div class="gap-s">
                    ...
                    <div class="padding-xs radius-xs">
                        <svg-icon src="https://rnbw.design/raincons/states.svg"></svg-icon>
                    </div>
                    <div class="background-secondary-onhover padding-xs radius-xs">
                        <svg-icon src="https://rnbw.design/raincons/media.svg"></svg-icon>
                    </div>
                </div>
                <div class="justify-stretch">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs background-secondary">
                            <svg-icon src="https://rnbw.design/raincons/width.svg"></svg-icon>
                        </div>
                ...
                <div class="justify-stretch opacity-m">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs">
                            <svg-icon src="https://rnbw.design/raincons/flex.svg"></svg-icon>
                        </div>
                ...
                <div class="justify-stretch">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs background-secondary">
                            <svg-icon src="https://rnbw.design/raincons/relative.svg"></svg-icon>
                        </div>
