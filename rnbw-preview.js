        ...
        <div class="panel">
                ...
                <div>
                    <div>
                        <div class="gap-s justify-start padding-s">
                            ...
                            <svg-icon src="https://rnbw.company/raincons/folder.svg"></svg-icon>
            ...
            <div class="">
                <div class="justify-stretch padding-xs background-tertiary">
                    <div class="gap-s padding-xs">
                        <svg-icon src="https://rnbw.company/raincons/down.svg" id="heading3-dropdown-icon"
        ...
        <div>
            ...
            <div class="panel padding-m gap-s">
                ...
                <div class="gap-s">
                    ...
                    <div class="padding-xs radius-xs">
                        <svg-icon src="https://rnbw.company/raincons/states.svg"></svg-icon>
                    </div>
                    <div class="background-secondary-onhover padding-xs radius-xs">
                        <svg-icon src="https://rnbw.company/raincons/media.svg"></svg-icon>
                    </div>
                </div>
                <div class="justify-stretch">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs background-secondary">
                            <svg-icon src="https://rnbw.company/raincons/width.svg"></svg-icon>
                        </div>
                ...
                <div class="justify-stretch opacity-m">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs">
                            <svg-icon src="https://rnbw.company/raincons/flex.svg"></svg-icon>
                        </div>
                ...
                <div class="justify-stretch">
                    <div class="gap-s box justify-start align-center">
                        <div class="padding-xs radius-xs background-secondary">
                            <svg-icon src="https://rnbw.company/raincons/relative.svg"></svg-icon>
                        </div>
