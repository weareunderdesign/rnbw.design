    ...
    <div id="reset">
      <div class="justify-stretch padding-xs background-secondary" id="anim-1">
        <div class="gap-s padding-xs">
          ...
          <svg-icon
            src="http://raincons.rnbw.design/icons/page.svg"
          ></svg-icon>
      ...
      <div class="justify-stretch padding-xs" id="anim-3">
        <div class="gap-s padding-xs">
          <div class="icon-xs"></div>
          <svg-icon
            src="http://raincons.rnbw.design/icons/code-js.svg"
          ></svg-icon>
      ...
      <div class="gap-s justify-start padding-s">
        <div class="icon-xs"></div>
        <svg-icon
          src="http://raincons.rnbw.design/icons/component.svg"
        ></svg-icon>
      ...
      <div>
        <div>
          <div class="gap-s justify-start padding-s">
            <svg-icon
              src="http://raincons.rnbw.design/icons/down.svg"
            ></svg-icon>
            <svg-icon
              src="http://raincons.rnbw.design/icons/folder.svg"
            ></svg-icon>
        ...
        <div>
          <div class="gap-s justify-start padding-s">
            ...
            <div class="icon-xs"></div>
            <svg-icon
              src="http://raincons.rnbw.design/icons/brush.svg"
            ></svg-icon>
            <span class="text-s">Stylesheet</span>
          </div>
        </div>
...
<div class="box align-stretch" style="display: flex;">
  ...
  <style>
    ...
    <svg-icon class="svg-image" src="https://rnbw.company/images/HTML.svg"></svg-icon>
  </div>
    <div
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const imageSourcesLight = [
    "https://rnbw.company/images/HTML.svg",
    "https://rnbw.company/images/CSS.svg",
    "https://rnbw.company/images/JS.svg"
  ];
