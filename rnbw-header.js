...
<nav class="box-l padding-l gap-l justify-stretch" id="rnbw-logo">
    ...
    <div class="gap-m justify-end box">
        ...
        <svg-icon src="https://rnbw.company/images/logo.svg" class="padding-s border radius-s icon-xl" id="header-item" style="display: flex; align-items: center;"></svg-icon>
            rnbw 0.1
        </a>
        <a id="nav-item" href="https://renecss.org" class="align-center column">
        <svg-icon src="https://rnbw.company/images/rene.svg" class="padding-s border radius-s icon-xl" id="header-item" style="display: flex; align-items: center;"></svg-icon>
        rene.css
        </a>
